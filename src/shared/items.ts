...
export const ITEMS: Record<ItemId, ItemSpec> = {
  ...
  log: { name: 'бревно', weight: 3, stack: 20, sell: 4, icon: '🪵' },
  ...
  meat: { name: 'сырое мясо', weight: 1.4, stack: 10, sell: 9, icon: '🥩' },
  meat_cooked: { name: 'жареное мясо', weight: 1.2, stack: 10, sell: 18, icon: '🍖' },
  hide_raw: { name: 'сырая шкура', weight: 2.6, stack: 6, sell: 14, icon: '🟫' },
  leather: { name: 'выделанная кожа', weight: 1.5, stack: 8, sell: 40, icon: '🧶' },
